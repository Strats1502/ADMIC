...
import mx.gob.admic.adapters.RVRegionAdapter;
import mx.gob.admic.api.RegionAPI;
import mx.gob.admic.api.Response;
import mx.gob.admic.application.MyApplication;
import mx.gob.admic.model.Region;
...
public class RegionFragment extends CustomFragment {
    ...
    public void onResume() {
        ...
        activity.getSupportActionBar().setHomeButtonEnabled(true);
        activity.getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        activity.getSupportActionBar().setTitle("Sucursales");
        cToolbar.setTitle("Sucursales");
        imagen.setImageResource(R.drawable.admic_sucursales);
