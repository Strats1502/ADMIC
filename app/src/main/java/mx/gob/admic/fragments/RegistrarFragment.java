...
import mx.gob.admic.activities.LoginActivity;
import mx.gob.admic.api.RegistroRequest;
import mx.gob.admic.api.Response;
import mx.gob.admic.api.UsuarioAPI;
import mx.gob.admic.application.MyApplication;
import mx.gob.admic.model.DatosUsuario;
...
*/
    ...
    public void continuar() {
        ...
        boolean pass1Empty = usuario == null && EditTextValidations.esCampoVacio(etPassword1);
        boolean pass2Empty = usuario == null && EditTextValidations.esCampoVacio(etPassword2);
        ...
        if (!imgPerfil.getDrawable().getConstantState().equals(getResources().getDrawable(R.drawable.placeholder).getConstantState())) {
            ...
            if (curpValido) {
                ...
                if (!curpEmpty && !emailEmpty && !pass1Empty && !pass2Empty && !cpEmpty) {
                    ...
                    pass1V = usuario != null || EditTextValidations.esContrasenaValida(etPassword1);
                    pass2V = usuario != null || EditTextValidations.esContrasenaValida(etPassword2);
