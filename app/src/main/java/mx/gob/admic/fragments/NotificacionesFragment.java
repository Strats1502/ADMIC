...
import mx.gob.admic.adapters.RVNotificacionAdapter;
import mx.gob.admic.application.MyApplication;
import mx.gob.admic.model.Notificacion;
import mx.gob.admic.notifications.FirebaseMessagingService;
...
public class NotificacionesFragment extends CustomFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        intentFilter = new IntentFilter("mx.gob.admic.NOTIFICACION_RECIBIDA");
    ...
    public void onResume() {
        ...
        imagen.setImageResource(R.drawable.admic_notificaciones);
