...
import mx.gob.admic.fragments.DetalleRegionFragment;
...
public class RVEventosAdapter extends RecyclerView.Adapter<RVEventosAdapter.EventosViewHolder> {
    ...
    public void onBindViewHolder(EventosViewHolder holder, int position) {
        ...
        if (eventos.get(position).getRutaImagen() != null) Picasso.with(context).load(eventos.get(position).getRutaImagen()).into(holder.imageViewImagenEvento);
    }
    ...
    public class EventosViewHolder extends RecyclerView.ViewHolder {
        ...
        EventosViewHolder(View itemView) {
            ...
            imageViewImagenEvento = (ImageView) itemView.findViewById(R.id.imageview_imagen_evento);
